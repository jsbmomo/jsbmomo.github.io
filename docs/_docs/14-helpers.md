...
**More Gallery Goodness:** A few more examples and [source code](https://github.com/{{ site.repository }}/blob/master/\_posts/2010-09-09-post-gallery.md) can be seen in [this sample gallery post]
 
## ({{ "" | relative_url }}{% post_url 2010-09-09-post-gallery %}).
## {: .notice--info}
